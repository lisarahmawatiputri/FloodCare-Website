...
@section('title', 'Blog Details - FlexStart')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <section id="blog-comments" class="blog-comments section">
                        <div class="container">
                            ...
                            <!-- Comment items dari HTML asli kamu taruh di sini -->
                            <!-- Saya ringkas, kamu bisa copy-paste semua comment dari HTML asli -->
                            ...
                            <div id="comment-1" class="comment">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p>Et rerum totam nisi. Molestiae vel quam dolorum vel voluptatem et et...</p>
                                    </div>
                                </div>
                            </div>

                            <!-- Tambahkan comment lainnya sesuai HTML asli -->
                ...
                <div class="col-lg-4 sidebar">
                    <!-- Sidebar sama seperti di blog.blade.php -->
                    <!-- Search, Categories, Recent Posts, Tags -->
                    <!-- Copy dari blog.blade.php atau HTML asli -->
                </div>
