                            ...
                            <div class="row gy-4">
                                    ...
                                    <article>
                                        ...
                                        <div class="meta-top">
                                            <ul>
                                                ...
                                                <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="{{ route('blog.details') }}"><time datetime="2022-01-01">Jan 1, 2022</time></a></li>
                                ...
                                <div class="col-12">
                                    <article>
                                        ...
                                        <h2 class="title">
                                            <a href="{{ route('blog.details') }}">Possimus soluta ut id suscipit ea ut. In quo quia et soluta libero sit sint.</a>
                                        </h2>
                                ...
                                <div class="col-12">
                                    <article>
                                        ...
                                        <h2 class="title">
                                            <a href="{{ route('blog.details') }}">Non rem rerum nam cum quo minus. Dolor distinctio deleniti explicabo eius exercitationem.</a>
                                        </h2>
